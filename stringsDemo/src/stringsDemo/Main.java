...
public class Main {
	...
	public static void main(String[] args) {
		...
		// .split fonksiyon kelimeleri belirli bir karaktere göre ayırma işlemi yapıyor.
		System.out.println(mesaj.toLowerCase());
		// .toLowerCase bütün harfleri küçük yazdırma.
		// .toUpperCase bütün harfleri büyük yazdırma.
		System.out.println(mesaj.toUpperCase());
		System.out.println(mesaj.trim());
		// .trim fonskiyonu cümlenin başındaki ve sonundaki boşluk karekterini atıyor.
